            ...
            <div class="card">
                ...
                <form method="post" action="<?= current_url() ?>">
                    <div class="form-group <?= (form_error('name')) ? 'has-error' : '' ?>">
                        <input type="text" name="name" class="form-control floating-label" placeholder="Name"
                               value="<?= set_value('name') ?>"/>
                        <small class="text-danger"><?= form_error('name') ?></small>
                    </div>
                    <div class="form-group <?= (form_error('email')) ? 'has-error' : '' ?>">
                        <input type="text" name="email" class="form-control floating-label" placeholder="Email Address"
                               value="<?= set_value('email') ?>"/>
                        <small class="text-danger"><?= form_error('email') ?></small>
                    </div>
                    <div class="form-group <?= (form_error('address')) ? 'has-error' : '' ?>">
                        <textarea name="address" class="form-control floating-label" rows="5"
                    ...
                    <div class="form-group <?= (form_error('website')) ? 'has-error' : '' ?>">
                        <input type="text" name="website" class="form-control floating-label" placeholder="Website"
                               value="<?= set_value('website') ?>"/>
                        <small class="text-danger"><?= form_error('website') ?></small>
                    </div>
                    <div class="form-group <?= (form_error('phone')) ? 'has-error' : '' ?>">
                        <input type="text" name="phone" class="form-control floating-label" placeholder="Phone Number"
                    ...
                    <div class="btn-group btn-block">
                        ...
                        <a href="<?= site_url('dashboard/index') ?>" class="btn btn-primary"><i class="fa fa-times"></i>
                            Cancel</a>
                    </div>
                </form>

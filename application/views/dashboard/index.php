   ...
   <table class="table table-bordered table-hover" width="100%">
    ...
    <tr>
      ...
      foreach ($details as $details) {
       ...
       <td><i class='fa fa-map-marker'></i> <?=nl2br($details->address)?><br /><br />
       <?php
       if($details->pin){
         echo "<i class='fa fa-paperclip'></i> ".$details->pin."<br />"; 
       }
       if($details->email){
         echo "<i class='fa fa-envelope'></i> ".$details->email."<br />"; 
       }
       if($details->website){
         echo "<i class='fa fa-globe'></i> ".$details->website."<br />"; 
       }
       ?>
       </td>
       ...
       <td>
        ...
        <a href="<?= site_url('dashboard/delete/'.$details->id) ?>" onclick="return confirm('Are you sure you want to remove this item ?');" title="delete"><i class="fa fa-trash-o"></i></a>
      </td>
